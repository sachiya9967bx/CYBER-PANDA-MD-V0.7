...
const isViewOnce = ["viewOnceMessageV2","viewOnceMessage"].includes(m.type)
	const botname = "𝐂𝐘𝐁𝐄𝐑--𝐏𝐀𝐍𝐃𝚫--𝚩𝚯𝚻𝐖𝚫";
	const devlopernumber = "+94767233346";
        // Group
...
if (m.text) {
    ...
    if (lowerText.includes('menu')) {
        await gss.sendMessage(m.chat, {
            image: { url: 'https://telegra.ph/file/91e6d18c6e0156e52ae0e.jpg' },
            caption: menuMessage,
            contextInfo: {
                externalAdReply: {
...
case 'scriptbot':
  if (isBan) return m.reply(mess.banned);
        if (isBanChat) return m.reply(mess.bangc);
    const githubRepoUrl = '█▄▄ █▀█ ▀█▀\n█▄█ █▄█ ░█░\n*https://github.com/sachiya9967bx/CYBER-PANDA-MD-V0.7*';
...
gss.sendMessage(m.chat, { caption: `  *X DL*
        
✍ *Title:* ${xn.title}
⌛ *Duration:* ${xn.duration}
📽 *Visual Quality:* ${xn.quality}
ＣＹＢＥＲ-ＰＡＮＤＡ-ＭＤ-V❼`, video: {url: xn.url_dl} }, { quoted: m })
}
break
...
case 'runtime': case '':
  if (isBan) return m.reply(mess.banned);
        if (isBanChat) return m.reply(mess.bangc);
                ...
                gss.sendMessage(m.chat, {
        image: fs.readFileSync('./image/alive.jpg'),
        caption: pinga,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
...
╰━━━━━━━━━━━━━━━┈⊷`;
    ...
    if (typemenu === 'v1') {
        gss.sendMessage(m.chat, {
            image: fs.readFileSync('./image/allmenu.jpg'),
            caption: introText,
            contextInfo: {
                externalAdReply: {
                    showAdAttribution: false,
        ...
        gss.sendMessage(m.chat, {
            video: fs.readFileSync('./image/gss.mp4'),
            caption: introText,
            sourceUrl: global.link,
            gifPlayback: true
        }, {
...
`;
    ...
    await gss.sendMessage(m.chat, {
        image: fs.readFileSync('./image/download.jpg'),
        caption: introText,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
...
`;
    ...
    await gss.sendMessage(m.chat, {
        image: fs.readFileSync('./image/searchmenu.jpg'),
        caption: introText,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
...
`;
    ...
    await gss.sendMessage(m.chat, {
        image: fs.readFileSync('./image/fun.jpg'),
        caption: introText,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
...
`;
    ...
    await gss.sendMessage(m.chat, {
        image: fs.readFileSync('./image/mainmenu.jpg'),
        caption: introText,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
...
`;
    ...
    await gss.sendMessage(m.chat, {
        image: fs.readFileSync('./image/aimenu.jpg'),
        caption: introText,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
...
`;
    ...
    await gss.sendMessage(m.chat, {
        image: fs.readFileSync('./image/tool.jpg'),
        caption: introText,
        contextInfo: {
            externalAdReply: {
                showAdAttribution: false,
